...
pub mod parser_tests {
    ...
    use crate::syntax::{ast::Expr, parser::Parser};
    ...
    #[test]
    fn let_stmt() {
        let parsed = parse_stmt("let foo: i32 = 0").strip_span();
    ...
    fn if_stmt() {
        ...
        let expected = Stmt::If {
            ...
            then_block: vec![
                Stmt::Expr(Expr::Ident("bar".to_string()).spanned_default().into())
                    .spanned_default(),
            ],
            elif_blocks: vec![],
    ...
    fn for_loop_stmt() {
        ...
        let expected = Stmt::For {
            ...
            body: vec![
                Stmt::Expr(Expr::Ident("foo".to_string()).spanned_default().into())
                    .spanned_default(),
            ],
        };
